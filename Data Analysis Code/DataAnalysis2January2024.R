...
DataTypesANOVAData <- rbind(CountryHospMSPEs,CountryICUMSPEs)
...
DataTypesANOVAData_LPRobust <- DataTypesANOVAData %>% filter(Model %in% c(
  "LProbust LC BC: Cumulative Data",
  "LProbust LC BC: Mixed Data",
  "LProbust LC BC: Daily Data",
  "LProbust LC US: Cumulative Data",
  "LProbust LC US: Mixed Data",
  "LProbust LC US: Daily Data",
  "LProbust LL BC: Cumulative Data",
  "LProbust LL BC: Mixed Data",
  "LProbust LL BC: Daily Data",
  "LProbust LL US: Cumulative Data",
  "LProbust LL US: Mixed Data",
  "LProbust LL US: Daily Data"
))

DataTypesANOVAData_LPRobust$ID <- paste(DataTypesANOVAData_LPRobust$Location, sub("\\:.*", "", DataTypesANOVAData_LPRobust$Model), DataTypesANOVAData_LPRobust$Response)
...
anova_test(data = DataTypesANOVAData_LPRobust, dv = MSPE, wid = ID, within = DataType)

get_anova_table(anova_test(data = DataTypesANOVAData_LPRobust, dv = MSPE, wid = ID, within = DataType))
...
anova_test(data = DataTypesANOVAData_tvReg, dv = MSPE, wid = ID, within = DataType)

get_anova_table(anova_test(data = DataTypesANOVAData_tvReg, dv = MSPE, wid = ID, within = DataType))
