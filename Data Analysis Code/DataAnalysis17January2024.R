...
NewOWIDData <- read.csv("owid-covid-data.csv")
...
# Change the values in the data frame to make the plots easier to read
CountryDeathsGridMSPEs$Model[CountryDeathsGridMSPEs$Model == "tvReg_LC"] <- "tvReg LC (default bandwidth selection)"
CountryDeathsGridMSPEs$Model[CountryDeathsGridMSPEs$Model == "tvReg_LC_grid"] <- "tvReg LC (gridsearch bandwidth selection)"
CountryDeathsGridMSPEs$Model[CountryDeathsGridMSPEs$Model == "tvReg_LL"] <- "tvReg LL (default bandwidth selection)"
CountryDeathsGridMSPEs$Model[CountryDeathsGridMSPEs$Model == "tvReg_LL_grid"] <- "tvReg LL (gridsearch bandwidth selection)"
...
ggplot(data=CountryDeathsGridMSPEs, aes(fill=Model, y=log(MSPE), x=Location, pattern=Model)) +
  ...
  ggtitle("Log of MSPEs for Different Bandwidth Selection Methods: Deaths") +
...
#### SECTION 5.2 ####
#### Country Results - Data Types Comparison - Hospitalizations ####

LocationsList <- c("Canada", "United States", "Israel", "South Africa")
...
# Change the values in the data frame to make the plots easier to read
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_CumulativeY"] <- "LProbust LC BC: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_mixedY"] <- "LProbust LC BC: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_rawY"] <- "LProbust LC BC: Daily Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_CumulativeY"] <- "LProbust LC US: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_mixedY"] <- "LProbust LC US: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_rawY"] <- "LProbust LC US: Daily Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_CumulativeY"] <- "LProbust LL BC: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_mixedY"] <- "LProbust LL BC: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_rawY"] <- "LProbust LL BC: Daily Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_CumulativeY"] <- "LProbust LL US: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_mixedY"] <- "LProbust LL US: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_rawY"] <- "LProbust LL US: Daily Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_CumulativeY"] <- "tvReg LC: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_mixedY"] <- "tvReg LC: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_rawY"] <- "tvReg LC: Daily Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_CumulativeY"] <- "tvReg LL: Cumulative Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_mixedY"] <- "tvReg LL: Mixed Data"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_rawY"] <- "tvReg LL: Daily Data"
...
ggplot(data=CountryHospMSPEs, aes(fill=Model, y=log(MSPE), x=Location, pattern=Model)) +
  ...
  #scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  ggtitle("Log of MSPE for Different Data Types: Hospitalizations") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") +
  ylab("Log of MSPE") +
  xlab("Country")
...
#### Country Results - Data Types Comparison - ICU Patients ####
...
# Change the values in the data frame to make the plots easier to read
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_CumulativeY"] <- "LProbust LC BC: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_mixedY"] <- "LProbust LC BC: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_rawY"] <- "LProbust LC BC: Daily Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_CumulativeY"] <- "LProbust LC US: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_mixedY"] <- "LProbust LC US: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_rawY"] <- "LProbust LC US: Daily Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_CumulativeY"] <- "LProbust LL BC: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_mixedY"] <- "LProbust LL BC: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_rawY"] <- "LProbust LL BC: Daily Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_CumulativeY"] <- "LProbust LL US: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_mixedY"] <- "LProbust LL US: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_rawY"] <- "LProbust LL US: Daily Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_CumulativeY"] <- "tvReg LC: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_mixedY"] <- "tvReg LC: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_rawY"] <- "tvReg LC: Daily Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_CumulativeY"] <- "tvReg LL: Cumulative Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_mixedY"] <- "tvReg LL: Mixed Data"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_rawY"] <- "tvReg LL: Daily Data"
...
ggplot(data=CountryICUMSPEs, aes(fill=Model, y=log(MSPE), x=Location, pattern=Model)) +
  ...
  scale_pattern_manual(values = rep(c("none", "stripe", "circle"), 6))+
  #scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  ggtitle("Log of MSPE for Different Data Types: ICU Patients") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") + 
  ylab("Log of MSPE") +
  xlab("Country")

CountryICUMSPEsReduced <- CountryICUMSPEs[grepl("LL BC", CountryICUMSPEs$Model, fixed=TRUE),]
CountryICUMSPEsReduced$DataType <- sub(".*:", "", CountryICUMSPEsReduced$Model)

ggplot(data=CountryICUMSPEsReduced, aes(fill=DataType, y=log(MSPE), x=Location)) +
  geom_col(position="dodge"
  ) + 
  theme(text = element_text(size = 16)) +    
  theme(axis.title = element_text(size = 15)) +
  theme(axis.text = element_text(size = 15)) +
  scale_fill_manual(values=rep(c("#fd7f6f", "#7eb0d5", "#b2e061"),5)) +
  ggtitle("Log of MSPE for Different Data Types") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") + 
  ylab("Log of MSPE") +
  xlab("Country")
...
#### Data Types Comparison - Repeated Measures ANOVA ####

DataTypesANOVAData <- CountryICUMSPEs

## LPRobust

# Data frame setup

DataTypesANOVAData_LPRobust <- DataTypesANOVAData %>% filter(Model %in% c(
  "LProbust LL US: Cumulative Data",
  "LProbust LL US: Mixed Data",
  "LProbust LL US: Daily Data"
))

DataTypesANOVAData_LPRobust$DataType <- sub(".*:", "", DataTypesANOVAData_LPRobust$Model)

# Boxplots

DataTypesANOVAData_LPRobust %>%
  ggplot(aes(x=DataType, y=log(MSPE), fill=DataType)) +
  geom_boxplot() +
  geom_point(position=position_dodge(width=0.75),aes(group=DataType)) +
  ggtitle("Boxplots of Log of MSPE for Different Data Types") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") + 
  ylab("Log of MSPE") +
  xlab("Data Type")
...
anova_test(data = DataTypesANOVAData_LPRobust, dv = MSPE, wid = Location, within = DataType)

get_anova_table(anova_test(data = DataTypesANOVAData_LPRobust, dv = MSPE, wid = Location, within = DataType))

# Pairwise t-tests

pairwise_t_test(MSPE ~ DataType, paired = TRUE, data = DataTypesANOVAData_LPRobust, p.adjust.method = "bonferroni")
...
DataTypesANOVAData_tvReg <- DataTypesANOVAData %>% filter(Model %in% c(
  "tvReg LL: Cumulative Data",
  "tvReg LL: Mixed Data",
  "tvReg LL: Daily Data"
))


#DataTypesANOVAData_tvReg$ID <- paste(DataTypesANOVAData_tvReg$Location, sub("\\:.*", "", DataTypesANOVAData_tvReg$Model), DataTypesANOVAData_tvReg$Response)

DataTypesANOVAData_tvReg$DataType <- sub(".*:", "", DataTypesANOVAData_tvReg$Model)

# Boxplots

DataTypesANOVAData_tvReg %>%
  ggplot(aes(x=DataType, y=log(MSPE), fill=DataType)) +
  geom_boxplot() +
  geom_point(position=position_dodge(width=0.75),aes(group=DataType)) +
  ggtitle("Boxplots of Log of MSPE for Different Data Types") +
...
anova_test(data = DataTypesANOVAData_tvReg, dv = MSPE, wid = Location, within = DataType)

get_anova_table(anova_test(data = DataTypesANOVAData_tvReg, dv = MSPE, wid = Location, within = DataType))

# Pairwise t-tests

pairwise_t_test(MSPE ~ DataType, paired = TRUE, data = DataTypesANOVAData_tvReg, p.adjust.method = "bonferroni")
...
# Change the values in the data frame to make the plots easier to read
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_70"] <- "LProbust LC BC: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_140"] <- "LProbust LC BC: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_bc_210"] <- "LProbust LC BC: 210 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_70"] <- "LProbust LC US: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_140"] <- "LProbust LC US: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LC_us_210"] <- "LProbust LC US: 210 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_70"] <- "LProbust LL BC: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_140"] <- "LProbust LL BC: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_bc_210"] <- "LProbust LL BC: 210 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_70"] <- "LProbust LL US: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_140"] <- "LProbust LL US: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "LProbust_LL_us_210"] <- "LProbust LL US: 210 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_70"] <- "tvReg LC: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_140"] <- "tvReg LC: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LC_210"] <- "tvReg LC: 210 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_70"] <- "tvReg LL: 70 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_140"] <- "tvReg LL: 140 Days"
CountryHospMSPEs$Model[CountryHospMSPEs$Model == "tvReg_LL_210"] <- "tvReg LL: 210 Days"


#Reorder the columns for graphing
CountryHospMSPEsGraphingDF <- CountryHospMSPEs %>%
  mutate(Model = fct_relevel(Model,
                              "LProbust LC BC: 70 Days",
                              "LProbust LC BC: 140 Days",
                              "LProbust LC BC: 210 Days",
                              "LProbust LC US: 70 Days",
                              "LProbust LC US: 140 Days",
                              "LProbust LC US: 210 Days",
                              "LProbust LL BC: 70 Days",
                              "LProbust LL BC: 140 Days",
                              "LProbust LL BC: 210 Days",
                              "LProbust LL US: 70 Days",
                              "LProbust LL US: 140 Days",
                              "LProbust LL US: 210 Days",
                              "tvReg LC: 70 Days",
                              "tvReg LC: 140 Days",
                              "tvReg LC: 210 Days",
                              "tvReg LL: 70 Days",
...
ggplot(data=CountryHospMSPEsGraphingDF, aes(fill=Model, y=log(MSPE), x=Location, pattern=Model)) +
  ...
  scale_pattern_manual(values = rep(c("none", "stripe", "circle"), each=6))+
  scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  ggtitle("Log of MSPE for Different Time Series Lengths: Hospitalizations") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") + 
  ylab("Log of MSPE") +
  xlab("Country")
...
# Change the values in the data frame to make the plots easier to read
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_70"] <- "LProbust LC BC: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_140"] <- "LProbust LC BC: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_bc_210"] <- "LProbust LC BC: 210 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_70"] <- "LProbust LC US: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_140"] <- "LProbust LC US: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LC_us_210"] <- "LProbust LC US: 210 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_70"] <- "LProbust LL BC: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_140"] <- "LProbust LL BC: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_bc_210"] <- "LProbust LL BC: 210 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_70"] <- "LProbust LL US: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_140"] <- "LProbust LL US: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "LProbust_LL_us_210"] <- "LProbust LL US: 210 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_70"] <- "tvReg LC: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_140"] <- "tvReg LC: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LC_210"] <- "tvReg LC: 210 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_70"] <- "tvReg LL: 70 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_140"] <- "tvReg LL: 140 Days"
CountryICUMSPEs$Model[CountryICUMSPEs$Model == "tvReg_LL_210"] <- "tvReg LL: 210 Days"
...
ggplot(data=CountryICUMSPEsGraphingDF, aes(fill=Model, y=log(MSPE), x=Location, pattern=Model)) +
  ...
  scale_pattern_manual(values = rep(c("none", "stripe", "circle"), each=6))+
  scale_x_discrete(guide = guide_axis(n.dodge = 2)) +
  ggtitle("Log of MSPE for Different Time Series Lengths: ICU Patients") +
  theme(plot.title = element_text(hjust = 0.5)) + 
  ylab("Log of MSPE") +
  xlab("Country")


#### DF Length Comparison - Repeated Measures ANOVA ####

CountryHospMSPEs$Response <- "Hospitalizations"

CountryICUMSPEs$Response <- "ICU"

DFLengthANOVAData <- rbind(CountryHospMSPEs,CountryICUMSPEs)

# DFLengthANOVAData %>%
#   group_by(DataType) %>%
#   get_summary_stats(MSPE, type = "mean_sd")

# Data frame setup

DFLengthANOVAData$ID <- paste(DFLengthANOVAData$Location, sub("\\:.*", "", DFLengthANOVAData$Model), DFLengthANOVAData$Response)

DFLengthANOVAData$DataType <- sub(".*:", "", DFLengthANOVAData$Model)
...
DFLengthANOVAData %>%
  ...
  geom_boxplot() +
  geom_point(position=position_dodge(width=0.75),aes(group=DataType)) +
  ggtitle("Boxplots of Log of MSPE for Different Time Series Lengths") +
  theme(plot.title = element_text(hjust = 0.5)) +
  theme(legend.position="right") +
  ylab("Log of MSPE") +
...
anova_test(data = DFLengthANOVAData, dv = MSPE, wid = ID, within = DataType)

get_anova_table(anova_test(data = DFLengthANOVAData, dv = MSPE, wid = ID, within = DataType))

# Pairwise t-tests

pairwise_t_test(MSPE ~ DataType, paired = TRUE, data = DFLengthANOVAData, p.adjust.method = "bonferroni")
...
#### Section 5.1 Sig Testing ####

CountryDeathsGridMSPEs$MSPE

CountryDeathsGridDifferences <- data.frame(matrix(CountryDeathsGridMSPEs$MSPE, ncol = 2, byrow = TRUE))
CountryDeathsGridDifferences <- CountryDeathsGridDifferences %>% mutate(Diff = X1 - X2)

t.test(CountryDeathsGridDifferences$Diff)
